...
public class CompagnieAutorouteTest {
	...
	public void testObtenirTarifExacte() {
		...
		assertEquals("Erreur calcul exacte du tarif", new BigDecimal("1.23E+3"),
				compagnieAutoroute.obtenirTarif(pA, pD));
	}
	...
	public void testObtenirTarifCalcule() {
		...
		Tarif t12 = new Tarif(p1, p2, new BigDecimal("1E+1")), t23 = new Tarif(p2, p3, new BigDecimal("2E+1")),
